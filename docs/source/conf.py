...
# d2_violencia_de_genero documentation build
...
from d2_violencia_de_genero import __version__ as release

# -- Project information -----------------------------------------------------

project = "d2_violencia_de_genero"
copyright = "2020, QuantumBlack Visual Analytics Limited"
author = "QuantumBlack"
...
htmlhelp_basename = "d2_violencia_de_generodoc"
...
latex_documents = [
    (
        master_doc,
        "d2_violencia_de_genero.tex",
        "d2_violencia_de_genero Documentation",
        "QuantumBlack",
        "manual",
    )
]
...
texinfo_documents = [
    (
        ...
        author,
        "d2_violencia_de_genero",
        "Project d2_violencia_de_genero codebase.",
        "Data-Science",
    )
]
